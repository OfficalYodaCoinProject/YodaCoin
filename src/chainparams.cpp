...
{
    const char* pszTimestamp = "BBC NEWS 21/01/2022 Russia Ukraine: Emergency diplomacy offers up few results";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 1 * 24 * 60 * 60; // 1day days
        consensus.nPowTargetSpacing = 1 * 60;    //1 min average block time
       ...
       // vSeeds.emplace_back("seed-a.yodacoin.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.yodacointools.com");
        //vSeeds.emplace_back("dnsseed.yodacoinpool.org");
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x05, 0x83, 0xB1, 0x1C};
        base58Prefixes[EXT_SECRET_KEY] = {0x03, 0x82, 0xAE, 0xE1};
