...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " yodacoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  yodacoin-tx [options] <hex-tx> [commands]  Update hex-encoded yodacoin transaction\n" +
            "or:     yodacoin-tx [options] -create [commands]   Create hex-encoded yodacoin transaction\n" +
            "\n";
