# Support for Output Descriptors in Yodacoin Core

Since Yodacoin Core v0.17, there is support for Output Descriptors. This is a
...
on Yodacoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Yodacoin Core wallets, a convenience function `combo` is
