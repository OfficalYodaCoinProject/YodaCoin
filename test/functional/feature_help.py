...
"""Verify that starting yodacoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start yodacoin with -h for help text")
        ...
        self.log.info("Start yodacoin with -version for version information")
        ...
        self.log.info("Start yodacoind with -fakearg to make sure it does not start")
